...
export type WhatsAppConfig = {
  ...
  groups?: Record<
    string,
    {
      ...
      /** Optional system prompt for this WhatsApp group. */
      systemPrompt?: string;
    }
  >;
  ...
  /** 
   * Optional system prompt for WhatsApp DMs.
   * This prompt is injected into every conversation to define the agent's personality and restrictions.
   * Used by OpenClaw Empresarial for dual-personality configuration.
   */
  systemPrompt?: string;
  /** 
   * Role of this channel for enterprise mode.
   * - 'superadmin': Full access (Telegram typically)
   * - 'public': Limited access for customer service (WhatsApp typically)
   */
