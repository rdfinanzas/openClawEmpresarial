...
export type GatewayConfig = {
  ...
  /** Configuration for the Superadmin role (Telegram exclusive). */
...
export type SuperAdminConfig = {
  /** Telegram User ID of the superadmin. */
  telegramUserId: number;
  /** Keyword to activate the bot for the superadmin session. */
  activationKeyword?: string;
  /** Whether the superadmin mode is enabled. */
  enabled?: boolean;
};

export type ChannelRoleConfig = {
  role: ChannelRole;
  allowedTools?: string[];
