...
import { createSuperAdminFilter } from "./superadmin-filter.js";
...
export function createTelegramBot(opts: TelegramBotOptions) {
  ...
  // Apply superadmin filter if configured
  const superadminFilter = createSuperAdminFilter(cfg.gateway?.superadmin);
  bot.use(superadminFilter);
